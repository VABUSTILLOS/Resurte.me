...
/**
 * Catálogo canjeable de la Tienda de Crecimiento. Los cambios se reflejan de
 * inmediato en /recompensas (la tienda pública lee reward_services vía
 * /api/recompensas/servicios).
 */
    ...
    <div>
      <div className="flex items-center justify-between mb-6 gap-3 flex-wrap">
        <p className="text-sm text-gray-500">
          Catálogo de servicios canjeables por Créditos Resurte. Los cambios se ven
          al instante en /recompensas.
        </p>
