              ...
              <div className="p-5 border-b border-gray-100">
                ...
                <div className="mt-4 flex items-center gap-2 flex-wrap border-t border-gray-100 pt-3">
                  ...
                  <button
                    ...
                    className="inline-flex items-center gap-1.5 rounded-full bg-white border border-red-200 px-3.5 py-2 text-xs font-semibold text-red-600 hover:bg-red-50 transition-colors"
                  >
                          ...
                          <td className="px-5 py-2.5">
                            <div className="flex items-center justify-end gap-1.5">
                              ...
                              <button
                                ...
                                className="inline-flex items-center gap-1 rounded-full px-2.5 py-1.5 text-[11px] font-semibold text-red-600 hover:bg-red-50 transition-colors"
                              >
