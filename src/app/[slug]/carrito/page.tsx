      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div className="lg:col-span-2 space-y-4">
          {cart.items.map((item) => (
            ...
            >
              <div className="w-20 h-20 rounded-lg bg-brand-50 flex items-center justify-center shrink-0">
                {item.image_url ? (
                  <Image src={item.image_url} alt={item.name} width={80} height={80} className="w-full h-full object-cover rounded-lg" />
                ) : (
              ...
              <div className="flex-1 min-w-0">
                <div className="flex justify-between gap-2">
                  ...
                  <button
                    ...
                    className="p-2.5 sm:p-1 rounded-lg hover:bg-red-50 text-gray-400 hover:text-red-500 transition-colors touch-target"
                    title="Quitar"
                  >
          ...
          {/* Cross-sell: order bumps inteligentes (mecánica ThriveCart). Mismo
              componente que /cart desktop y el drawer móvil. Ubicados DESPUÉS
              de la lista de items para que el usuario primero revise sus
              productos y luego vea las sugerencias complementarias. */}
          <BumpCards
