           ...
           {inSeasonNow.map((item) => {
             ...
             <div key={item.key} className={`rounded-xl px-3 py-2.5 border ${inList ? "bg-emerald-100 border-emerald-300" : "bg-emerald-50 border-emerald-100"}`}>
               <div className="flex items-center justify-between gap-1 mb-1.5">
                 ...
                 <button
                   ...
                   className={`shrink-0 w-6 h-6 rounded-full flex items-center justify-center text-xs font-bold transition-colors ${
                     inList ? "bg-emerald-700 text-white" : "bg-white text-emerald-700 hover:bg-emerald-700 hover:text-white border border-emerald-200"
                   }`}
               ...
               <button
                 ...
                 className="w-full text-[10px] font-semibold bg-white text-emerald-700 hover:bg-emerald-700 hover:text-white border border-emerald-200 rounded-lg py-1 transition-colors flex items-center justify-center gap-1"
               >
            ...
            <div className="flex items-center justify-between mb-3">
              ...
              <div className="flex items-center gap-2">
                ...
                <button
                  ...
                  className="flex items-center gap-1 text-xs font-semibold text-white bg-emerald-700 hover:bg-emerald-800 px-2.5 py-1.5 rounded-lg transition-colors"
        ...
        {tips.map((tip, idx) => (
          <div key={idx} className="bg-white rounded-2xl border border-gray-100 p-5">
            <div className="flex items-center gap-2 mb-2">
              ...
              <span className="text-xs text-gray-600 bg-gray-100 px-2 py-0.5 rounded-full">{tip.months}</span>
            </div>
