...
export function BlogCTA({
  ...
  // Cliente: la ciudad se resuelve del contexto tras la hidratación (SSR usa
  // la ciudad por defecto). Antes leía cookies() en el servidor y convertía
  // todas las páginas del blog en dinámicas.
  const { city } = useCity()
