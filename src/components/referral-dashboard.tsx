    ...
    <div className="max-w-2xl mx-auto px-4 sm:px-6 py-8">
      ...
      >
        ...
        <div className="flex items-center justify-between mt-2">
          ...
          <button
            onClick={handleCopy}
            className="flex items-center gap-1.5 rounded-xl bg-white/20 hover:bg-white/30 px-4 py-2 text-sm font-semibold transition-colors touch-target"
          >
            {copied ? (
              <>
        ...
        <div className="flex gap-2 mt-4">
          <button
            ...
            className="flex-1 flex items-center justify-center gap-2 rounded-xl bg-green-500 hover:bg-green-600 py-2.5 text-sm font-semibold transition-colors touch-target"
          >
