          ...
          <div className="flex flex-col sm:flex-row sm:items-center gap-3">
            ...
            <div className="flex items-center gap-2 overflow-x-auto scrollbar-hide scroll-fade-x snap-x snap-mandatory flex-1">
              ...
              >
                ...
                Todo
                <span className="text-[13px] ml-0.5">{allCount}</span>
              </button>
              {orderedCategories.map((cat) => {
                ...
                return (
                  ...
                  >
                    ...
                    {cat.name}
                    <span className="text-[13px] ml-0.5">{count}</span>
                  </button>
                )
              })}
            </div>
          ...
          <section>
            ...
            <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-3 sm:gap-4">
              {sortedResults.map((product, idx) => (
                <ScrollReveal key={product.id} direction="scale" delay={Math.min(idx * 0.03, 0.3)} className="h-full">
