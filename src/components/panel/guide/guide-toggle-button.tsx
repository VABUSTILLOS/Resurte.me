 ...
 * navegación rápida (body.has-panel-bottom-nav) y del quick-nav (z-40).
 */
export default function GuideToggleButton({ onClick, label = "Guía" }: GuideToggleButtonProps) {
  return (
    <button
      onClick={onClick}
      className="fixed bottom-5 right-4 z-50 flex items-center gap-1.5 rounded-full bg-gray-900 text-white pl-2.5 pr-3 py-2 shadow-lg hover:bg-gray-700 transition-colors touch-target"
