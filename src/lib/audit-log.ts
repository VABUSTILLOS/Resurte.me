...
export const AUDIT_ACTIONS = [
  ...
  "bump_rule_update",
  "bump_rule_delete",
  "affinity_pair_create",
  "affinity_pair_update",
  "affinity_pair_delete",
  "driver_create",
  "driver_update",
  "lead_convert",
  "lead_discard",
...
export const AUDIT_ACTION_LABEL: Record<AuditAction, string> = {
  ...
  order_cancelled_by_customer: "Cancelación por el cliente",
  order_driver_assigned: "Repartidor asignado",
  order_driver_unassigned: "Repartidor desasignado",
  ...
  user_permissions: "Cambio de permisos de admin",
  ...
  affinity_pair_create: "Par de afinidad creado",
  affinity_pair_update: "Par de afinidad editado",
  affinity_pair_delete: "Par de afinidad eliminado",
  ...
  crm_prospect_close: "Cierre de trato del prospecto",
  crm_prospect_create: "Prospecto creado desde el panel",
  crm_prospect_update: "Prospecto editado desde el panel",
  crm_prospect_import: "Prospectos importados por CSV",
  ...
  crm_task_create: "Tarea del CRM creada",
  crm_task_complete: "Tarea del CRM completada",
  crm_task_reopen: "Tarea del CRM reabierta",
  crm_task_delete: "Tarea del CRM eliminada",
  crm_activity_update: "Actividad de prospecto editada",
  crm_activity_delete: "Actividad de prospecto eliminada",
  ...
  foodos_platform_fee_update: "Comisión de plataforma actualizada",
