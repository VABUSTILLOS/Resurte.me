...
export function validateProductPatch(
  ...
  if ("brand" in updates && updates.brand !== null && typeof updates.brand !== "string") {
    return { ok: false, error: "brand debe ser texto o null" }
  }
  if (
    ...
    return { ok: false, error: "description debe ser texto o null" }
  }
  if ("unit" in updates && updates.unit !== null && typeof updates.unit !== "string") {
    return { ok: false, error: "unit debe ser texto o null" }
  }
  ...
  for (const field of ["publish_at", "unpublish_at", "sale_starts_at", "sale_ends_at"] as const) {
    if (field in updates) {
      ...
      if (v !== null && (typeof v !== "string" || Number.isNaN(new Date(v).getTime()))) {
        return { ok: false, error: `${field} debe ser una fecha ISO válida o null` }
      }
    }
  }
  ...
  if (
    ...
    return { ok: false, error: "admin_note debe ser texto o null" }
  }
  ...
  if ("images" in updates) {
    ...
    if (
      ...
      return { ok: false, error: "images debe ser un arreglo de URLs https o rutas locales" }
    }
  }
  ...
  for (const field of ["price", "sale_price"] as const) {
    if (field in updates) {
      ...
      if (v !== null && (typeof v !== "number" || !Number.isFinite(v) || v < 0)) {
        return { ok: false, error: `${field} debe ser un número ≥ 0 o null` }
      }
    }
  }
  ...
  if ("tags" in updates) {
    ...
    if (raw !== null && !Array.isArray(raw)) {
      return { ok: false, error: "tags debe ser un arreglo de etiquetas o null" }
    }
    if (raw === null) {
      updates.tags = []
    } else {
      ...
      for (const t of raw as unknown[]) {
        if (typeof t !== "string") {
          return { ok: false, error: "cada etiqueta debe ser texto" }
        }
        const clean = t.trim().toLowerCase()
        if (!clean) continue
        if (clean.length > 40) {
          return { ok: false, error: "cada etiqueta admite hasta 40 caracteres" }
        }
        seen.add(clean)
      }
      if (seen.size > MAX_TAGS) {
        return { ok: false, error: `máximo ${MAX_TAGS} etiquetas por producto` }
      }
      updates.tags = [...seen]
    }
  }
  ...
  if ("low_stock_threshold" in updates) {
    ...
    if (v !== null && (typeof v !== "number" || !Number.isInteger(v) || v < 0)) {
      return { ok: false, error: "low_stock_threshold debe ser un entero ≥ 0 o null" }
    }
  }
  ...
  if ("related_product_ids" in updates) {
    ...
    if (raw !== null && !Array.isArray(raw)) {
      return { ok: false, error: "related_product_ids debe ser un arreglo de ids o null" }
    }
    if (raw === null) {
  ...
  if ("image_url" in updates) {
    ...
    if (
      ...
      return { ok: false, error: "image_url debe ser una URL https, una ruta local o null" }
    }
  }
