...
const products = [
  ...
  { name:"Pepinillos Encurtidos 1kg", slug:"pepinillos-1kg", desc:"Pepinillos agridulces en rodajas para hamburguesas y hot dogs.", img:"/images/products/recipe/pepinillos.webp", brand:"Del Monte", cat:2, tags:["hamburgueseria","burger","hotdog","arabe","griega"], unit:"1kg", price:65 },
  ...
  { name:"Chile Guajillo Seco 500g", slug:"chile-guajillo-seco", desc:"Chile guajillo seco para salsas, adobos y moles mexicanos.", img:"/images/products/recipe/chile-guajillo.webp", brand:"Local", cat:2, tags:["taqueria","tacos","mexicana","fonda","cocina-economica","antojitos"], unit:"500g", price:85 },
  { name:"Chile Ancho Seco 500g", slug:"chile-ancho-seco", desc:"Chile ancho seco, base fundamental de moles y adobos mexicanos.", img:"/images/products/recipe/chile-ancho.webp", brand:"Local", cat:2, tags:["taqueria","tacos","mexicana","fonda","cocina-economica"], unit:"500g", price:90 },
  ...
  { name:"Pasta de Achiote 200g", slug:"pasta-achiote", desc:"Pasta de achiote concentrada. Para cochinita pibil y adobos yucatecos.", img:"/images/products/recipe/achiote.webp", brand:"El Yucateco", cat:2, tags:["taqueria","tacos","mexicana","fonda","cocina-economica","guisados"], unit:"200g", price:32 },
  ...
  { name:"Alga Nori 50 Hojas", slug:"alga-nori-50hojas", desc:"Alga nori dorada para sushi rolls. Paquete de 50 hojas completas.", img:"/images/products/recipe/alga-nori.webp", brand:"Toyo", cat:2, tags:["sushi","japonesa","asiatica"], unit:"50 piezas", price:145 },
  ...
  { name:"Pepperoni Rebanado 1kg", slug:"pepperoni-1kg", desc:"Pepperoni de cerdo y res en rebanadas para pizza. Sabor ahumado intenso.", img:"/images/products/recipe/pepperoni.webp", brand:"Sigma", cat:4, tags:["pizzeria","italiana"], unit:"1kg", price:210 },
  ...
  { name:"Levadura Instantánea 500g", slug:"levadura-instantanea-500g", desc:"Levadura instantánea para panadería y pizza. Alta actividad.", img:"/images/products/recipe/levadura.webp", brand:"Saf-Instant", cat:5, tags:["pizzeria","italiana","panaderia","postres"], unit:"500g", price:68 },
  ...
  { name:"Tostadas de Maíz 20pz", slug:"tostadas-maiz-20pz", desc:"Tostadas de maíz crujientes. Base para ceviche, aguachile y mariscos.", img:"/images/products/generic/tostadas.webp", brand:"Milpa Real", cat:5, tags:["marisqueria","mariscos","pescados","taqueria","mexicana"], unit:"20 piezas", price:38 },
  ...
  { name:"Surimi 1kg", slug:"surimi-1kg", desc:"Surimi premium de primera calidad. Para ensaladas, sushi y mariscos.", img:"/images/products/recipe/surimi.webp", brand:"Toyo", cat:4, tags:["marisqueria","mariscos","sushi","asiatica"], unit:"1kg", price:125 },
  ...
  { name:"Quinoa 1kg", slug:"quinoa-1kg", desc:"Quinoa blanca orgánica. Proteína completa, base para bowls y ensaladas.", img:"/images/products/recipe/quinoa.webp", brand:"Local", cat:2, tags:["saludable","ensaladas","poke","organico"], unit:"1kg", price:120 },
  ...
  { name:"Almendras 500g", slug:"almendras-500g", desc:"Almendras enteras sin cáscara. Para panadería fina, mazapanes y repostería.", img:"/images/products/recipe/almendras.webp", brand:"Local", cat:2, tags:["postres","panaderia","reposteria","saludable","ensaladas"], unit:"500g", price:175 },
  ...
  { name:"Jocoque 1kg", slug:"jocoque-1kg", desc:"Jocoque natural estilo libanés. Para tacos árabes, shawarma y aderezos.", img:"/images/products/recipe/jocoque.webp", brand:"Local", cat:3, tags:["arabe","griega","trompo","kebab","taqueria"], unit:"1kg", price:78 },
  { name:"Carne de Cerdo para Trompo 3kg", slug:"carne-cerdo-trompo", desc:"Carne de cerdo adobada lista para trompo. Sabor tradicional árabe-mexicano.", img:"/images/products/carne-trompo.webp", brand:"Resurte", cat:4, tags:["arabe","griega","trompo","taqueria","tacos","mexicana"], unit:"3kg", price:340 },
