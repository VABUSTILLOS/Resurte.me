...
const products = [
  ...
  ['Surimi', 'surimi', 'Palitos de surimi para sushi california y ensaladas.', '/images/products/recipe/surimi.webp', 'Del Pacífico', 4, true, 'paquete 250 g'],
...
// Prices per category for Resurte.me
const catPrices = {
...
async function main() {
  ...
  for (const [catId, ids] of Object.entries(byCat)) {
    ...
    console.log('  Priced cat', catId, ':', ids.length, 'products')
  }
