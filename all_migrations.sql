...
-- ============================================================
-- MIGRATION 00018: Sistema de Referidos
-- ============================================================
...
-- Trigger para asignar referral_code automáticamente al crear perfil
...
-- Asignar códigos a usuarios existentes que no tengan uno
UPDATE profiles SET referral_code = generate_referral_code() WHERE referral_code IS NULL;

-- Función para procesar la recompensa por referido ($100 MXN)
