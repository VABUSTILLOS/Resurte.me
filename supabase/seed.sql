...
INSERT INTO products (name, slug, description, image_url, images, brand, category_id, show_in_whatsapp, unit) VALUES
  ...
  ('Bistec de Res', 'bistec-de-res', 'Bistec de res seleccionado, marmoleo parejo y sabor profundo. Para asar o plancha.', '/images/products/generic/bistec-de-res.webp', jsonb_build_array('/images/products/generic/bistec-de-res.webp'), 'Local', 4, false, 'por kilo'),
  ('Milanesa de Res', 'milanesa-de-res', 'Milanesa de res aplanada, corte delgado y parejo. Lista para empanizar o asar rápido.', '/images/products/111.webp', NULL, 'Local', 4, true, 'por kilo'),
  ('Carne Molida 80/20', 'carne-molida-80-20', 'Carne molida de res 80% magra. Textura uniforme para hamburguesas, albóndigas y rellenos.', '/images/products/112.webp', NULL, 'Local', 4, true, 'por kilo'),
  ('Diezmillo de Res', 'diezmillo-de-res', 'Diezmillo para cocción lenta. Perfecto para birria, caldos, deshebrada y barbacoa.', '/images/products/113.webp', NULL, 'Local', 4, true, 'por kilo'),
  ('Falda de Res', 'falda-de-res', 'Falda de res para cocción prolongada. Ideal para caldos de res, cocido y guisos.', '/images/products/generic/falda-de-res.webp', jsonb_build_array('/images/products/generic/falda-de-res.webp'), 'Local', 4, false, 'por kilo'),
  ('Costilla de Res', 'costilla-de-res', 'Costilla de res en tira, marmoleo generoso. Para asar, hornear o guisar.', 'https://storage.googleapis.com/takeapp/media/cmigudmvx000p04jp7knq43u4.png', '["https://storage.googleapis.com/takeapp/media/cmii8rwpx000304la4njhc1ya.png"]'::jsonb, 'Local', 4, false, 'por kilo'),
  ('Arrachera', 'arrachera', 'Arrachera marinada de res. Suave, jugosa y lista para asador. Corte premium para taquería.', '/images/products/116.webp', NULL, 'Local', 4, true, 'por kilo'),
  ('Ribeye', 'ribeye', 'Corte Ribeye de res con marmoleo superior. Para parrilla de alto nivel y servicio premium.', '/images/products/117.webp', NULL, 'Local', 4, false, 'por kilo'),
  ('T-Bone', 't-bone', 'Corte T-Bone de res con hueso, dos cortes en uno. Espectacular a la parrilla.', '/images/products/118.webp', NULL, 'Local', 4, false, 'por kilo'),
